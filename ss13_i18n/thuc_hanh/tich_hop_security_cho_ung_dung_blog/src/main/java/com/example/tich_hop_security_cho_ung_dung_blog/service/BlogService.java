...
import com.example.tich_hop_security_cho_ung_dung_blog.repository.IBlogRepository;
...
public class BlogService implements IBlogService {
    ...
    @Override
    public Page<MyBlog> searchByName(String searchByName,int id, Pageable pageable) {
        return blogRepository.searchByName(searchByName,id,pageable);
    }
}
